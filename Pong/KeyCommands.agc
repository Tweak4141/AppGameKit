...
function InputLeft()
	if GetRawKeyState(KEY_LEFT) then exitfunction 1
endfunction 0

function InputRight()
	if GetRawKeyState(KEY_RIGHT) then exitfunction 1
endfunction 0
...
function InputA()
	if GetRawKeyState(KEY_A) then exitfunction 1
endfunction 0

function InputD()
	if GetRawKeyState(KEY_D) then exitfunction 1
endfunction 0        
